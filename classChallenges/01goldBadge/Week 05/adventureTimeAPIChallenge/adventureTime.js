...
3. Find out how you will use these results to display the quote to the page.
...
//         .then((json) => {
//             console.log(json);
//             // let quote = document.getElementsByTagName("body");
//             // console.log(quote);
...
let url = "https://adventure-time-quote-api.glitch.me/api/random";  //step 1

const section = document.getElementById("quotes");  //step 3, part  1
...
function displayResults(quote){
    ...
    let img = document.createElement('img');        //step 5, part 2

    section.appendChild(heading);
    section.appendChild(img);             //step 5, part 3

    heading.textContent = quote.split(":")[1];          //step 4 heading.textContent = quote; step 5. part 1 adding the split() method
