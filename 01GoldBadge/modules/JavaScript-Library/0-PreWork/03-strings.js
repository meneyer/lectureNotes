...
console.log("My bank accound had two million bucks in it.  It's gone now.");
...
let age = "21";
let years = "3";
console.log(age + years);  //Result = 213 because numbers in quotes aren't numbers, they are text.
