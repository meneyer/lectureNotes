document.querySelector('.grid').addEventListener('contextmenu', function(e) {
    e.preventDefault();  //this prevents the normal right click menu from showing up when you want to see the photo, not the menu.
    ...
    } //check to see that I clicked on an IMG only
}) //click event